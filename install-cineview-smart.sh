...
case "$IMAGE" in
  *openbh*) TAG="v2.3.4"; PKG="enigma2-plugin-skins-cineview-openbh_2.3.4_all.ipk" ;;
  *openvix*) TAG="v2.3.4"; PKG="enigma2-plugin-skins-cineview-openvix_2.3.4_all.ipk" ;;
  *openatv*) TAG="v2.3.4"; PKG="enigma2-plugin-skins-cineview-openatv_2.3.4_all.ipk" ;;
...
printf "\033[1;32mInstalling CineView FHD 2.3.4...\033[0m\n"
